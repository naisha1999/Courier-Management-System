        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a></a></li>
            ...
            <li><a href="viewcourier.php">View Courier</a></li>
...
<button onclick="window.location.href='payment.php'"class="btn btn-primary btn-large" style="background-color: #000;align-center;" type="submit">Proceed for Payment</button>
	</div>	
