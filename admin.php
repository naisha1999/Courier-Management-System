        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a></a></li>
            ...
            <li><a href="totalvistors.php">Reports</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="report.jpg" width="200" height="200" border="4" >
			   
            <form action="reporting.php" method="post">
           <br> <input type='submit' style="padding:30px;font-size:20px;height:30px;width:190px;background-color:	#1E90FF;color:white"name='submit' value='Click here!!'>
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="employeeremove.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <form action="removeemp.php" method="post" name="form" id="form" >
                        <input name="emp" class="gentxt" id="emp" maxlength="50" type="text" /><br>
                        <input type='submit' style="padding:30px;font-size:16px;height:30px;width:190px;background-color:#FF0000	;color:white"name='submit' value='Remove Employee'!!'>
                     <br> <span class="gentxt style1">Ex: rasesh </span> 
					  </form>
</div>
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="employeee.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <form action="viewemp.php" method="post">
                  <br>   <input type='submit' style="padding:30px;font-size:20px;height:30px;width:190px;background-color:#8B008B	;color:white"name='submit' value='Click here!!'>
			 ...
			 <div class="col-xs-6 col-sm-3 placeholder">
              <img src="04.jpg" width="200" height="900" class="img-responsive" alt="Generic placeholder thumbnail">
            
			  <form action="index.php" method="post">
                    <br>     <input type='submit' style="padding:30px;font-size:20px;height:30px;width:190px;background-color:#FF1493;color:white"name='submit' value='Click here!!'>
