      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a></a></li>
            <li><a href="cust.php">AddCourier</a></li>
        ...
        <div id="Track Courier" class="container-fluid bg-grey">
  <h2 class="text-center">	Track Courier</h2>
	  <form action="trackhome.php" method="post" name="frmShipment" >
         <h2>Sender'sname</h3>
		 <input type='text' name='username'required>
		 <h2>Courier ID (cid)</h2>
		 <input type='number' name='cid' required>
		 <br>
		 <br>
		 <input type='submit' name='submit' value='Track Now !!'>
                            </form>
