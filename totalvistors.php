        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a></a></li>
            ...
            <li><a href="#Testimonial">Reports</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="row placeholders">
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
                               ...
                               <div class="card text-white bg-warning mb-3" style="width: 23rem;height:18rem;background-color:#3bebf1;">
                                    <div class="card-body">
...
mysqli_select_db($con,"courier");
		...
		$sql2="select SUM(rate) as TOTAL from courier_table";
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
                                 ...
                                 <div class="card text-white bg-warning mb-3" style="width: 23rem;height:18rem;background-color:#f23c7f;">
                                    <div class="card-body">
...
mysqli_select_db($con,"courier");
											...
											$sql3=mysqli_query($con,"select COUNT(*) as count from client");
							...
							<div class="col-xs-6 col-sm-3 placeholder">
                               ...
                               <div class="card text-white bg-warning mb-3" style="width: 23rem;height:18rem;background-color:red;">
                                    <div class="card-body">
...
mysqli_select_db($con,"courier");
											...
											$sql3=mysqli_query($con,"select COUNT(*) as count from employee");
											$data=mysqli_fetch_array($sql3);
											$count=$data['count'];
											echo "<strong>$count</strong>";
											?></h1>
...
mysqli_select_db($con,"tbl_users");
$sql3=mysqli_query($con,"select COUNT(*) as count from tbl_users");
											$data=mysqli_fetch_array($sql3);
											$count=$data['count'];
											echo "<strong>$count</strong>";
 ...
 $query = "SELECT status, count(*) as number FROM courier_table GROUP BY status";  
