        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           <li><a></a></li>
            ...
            <li><a href="#Resports">Reports</a></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="tracking.jpg" width="200" height="200" border="4" >
			   
            <form action="viewce.php" method="post">
           <br> <input type='submit' style="padding:30px;font-size:20px;height:30px;width:190px;background-color:	#1E90FF;color:white"name='submit' value='Click here!!'>
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="update.png"  border="4"width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <form action="updatestatus.php" method="post" name="form" id="form" >
                     <span class="gentxt style1">CourierID </span>   
